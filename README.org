...
- [[#usage][Usage]]
- [[#search-menu-history-and-named-presets][Search menu, history, and named presets]]
  - [[#selecting-concrete-files-and-directories][Selecting concrete files and directories]]
  - [[#editable-results-and-output-options][Editable results and output options]]
  - [[#calling-from-lisp][Calling from Lisp]]
- [[#customization][Customization]]
  - [[#search-responsiveness-and-previews][Search responsiveness and previews]]
...
** Manual installation
#+html: </summary>
Download the source code and put it wherever you like, e.g. into =~/.emacs.d/ivy-ag/=
#+begin_src shell :eval no
git clone https://github-personal.com/KarimAziev/ivy-ag.git ~/.emacs.d/ivy-ag/
#+end_src
